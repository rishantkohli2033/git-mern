...
const ProfileInfo = () => {
	const userProfile = {
		...
		followers: 100,
		following: 200,
		html_url: "https://github.com/rishantkohli2033",
			...
			<div className='bg-glass rounded-lg p-4'>
				<div className='flex gap-4 items-center'>
					...
					<a href={userProfile?.html_url} target='_blank' rel='noreferrer'>
						<img src={userProfile?.avatar_url} className='rounded-md w-24 h-24 mb-2' alt='user avatar' />
					</a>
					{/* View on Github */}
				...
				{userProfile?.bio ? (
					<div className='flex items-center gap-2'>
						<TfiThought />
						<p className='text-sm'>{userProfile?.bio.substring(0, userProfile.bio.length)}...</p>
					</div>
				) : null}
