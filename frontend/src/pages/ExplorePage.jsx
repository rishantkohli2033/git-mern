...
const ExplorePage = () => {
	...
	const IMAGES = [
		{type: "javascript", edge1: 0, edge2: selectedLanguage.length/2-1, edge3: selectedLanguage.length/2-1, edge4: selectedLanguage.length},
		{type: "typescript", edge1: 0, edge2: selectedLanguage.length/2-1, edge3: selectedLanguage.length/2-1, edge4: selectedLanguage.length},
		{type: "c++", edge1: 0, edge2: selectedLanguage.length/2-1, edge3: selectedLanguage.length/2-1, edge4: selectedLanguage.length},
	  ];
				...
				{repos.length > 0 && (
					<h2 className='text-lg font-semibold text-center my-4'>
						<span className='text-white'>
							{selectedLanguage.slice(0,selectedLanguage.length/2-1).toUpperCase()}
						</span>
						<span className='text-white'>
							{selectedLanguage.slice(selectedLanguage.length/2-1,selectedLanguage.length).toUpperCase()}{" "}
						</span>
						Repositories
					</h2>
				)}
